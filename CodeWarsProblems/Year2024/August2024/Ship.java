...
public class Ship {
    ...
    public static void main(String[] args) {
        Ship titanic = new Ship(50.0, 100);
        Ship blackPearl = new Ship(30.0, 50);

        System.out.println("Is Titanic worth looting? " + titanic.isWorthIt());
        System.out.println("Is Black Pearl worth looting? " + blackPearl.isWorthIt());
    }
}
